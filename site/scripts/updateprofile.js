...
function update(){
	...
	document.getElementById('picstudent').style.display = 'none';
	document.getElementsByClassName('input_btn')[0].style.display = 'block';
}
function cancel(){
	...
	document.getElementById('picstudent').style.display = 'block';
	document.getElementsByClassName('input_btn')[0].style.display = 'none';
}
